...
const toggleSubCategory = (e) => {
  ...
  useEffect(() => {
    ...
    if (Category.includes('Men')) {
      subs = ['Shirt','Pants','T-shirt','Panjabi'];
    } else if (Category.includes('Women')) {
      subs = ['Salwar Kameez','Kameez','Saree','Top','Skirt','Palazzo'];
    } else if (Category.includes('Boys Kid')) {
      subs = ['Kid Shirt','Kid Pants','Kid T-Shirt','Kid Panjabi'];
    }else if (Category.includes('Girls Kid')) {
      subs = ['Kid Salwar Kameez','Kid Frock','Kid Palazzo'];
    }
